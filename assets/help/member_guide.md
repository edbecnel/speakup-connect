...
- **Email** — use your contact email if one is on your profile
- **Student ID** — school-issued username for provisioned accounts
...
If your organization uses groups, you may **browse and request to join** open clubs, or an administrator may add you directly. View memberships on **Home** or **Settings → My Groups & Clubs**. You may **leave** or **request to leave** depending on each group’s policy. Group membership may determine which **Alerts** you receive.
