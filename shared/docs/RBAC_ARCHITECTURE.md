...
| Interactive UI mockup | ✅ [`shared/docs/mockups/roles-management-mockup.html`](mockups/roles-management-mockup.html) |
...
| Custom Claims Cloud Function | ✅ Complete — `shared/functions/src/index.ts` (`syncCustomClaims`, `refreshMyPermissions`) |
