...
5. **Review Everything** — AI output must be reviewed against `shared/docs/CODING_STANDARDS.md` before committing
...
```
1. Check shared/docs/SPRINT_TRACKER.md → Is the task in the current sprint?
2. Read shared/docs/ARCHITECTURE.md → Understand the layer where the code goes
3. Read shared/docs/CODING_STANDARDS.md → Understand naming and structural rules
4. Read shared/docs/DATABASE_DESIGN.md → If writing Firestore code, review the schema
5. Write the code (with AI assistance)
6. Review: Does it follow the architecture? Does it follow the coding standards?
7. Update shared/docs/SPRINT_TRACKER.md → Check off the completed task
```
...
```
1. Open shared/docs/SPRINT_TRACKER.md
...
- [ ] Does the file path match the folder structure in `shared/docs/FOLDER_STRUCTURE.md`?
- [ ] Does the class name follow the naming conventions in `shared/docs/CODING_STANDARDS.md`?
...
[paste schema from shared/docs/DATABASE_DESIGN.md]
```
...
1. **Check `shared/docs/ARCHITECTURE.md`** — Does the planned approach align with the defined architecture?
2. **Check `shared/docs/FOLDER_STRUCTURE.md`** — Where will the new files go?
3. **Check `shared/docs/DATABASE_DESIGN.md`** — If touching Firestore, is the schema already defined?
...
- [ ] Naming follows `shared/docs/CODING_STANDARDS.md`
- [ ] Folder placement follows `shared/docs/FOLDER_STRUCTURE.md`
...
2. Update shared/docs/SPRINT_TRACKER.md with blockers and notes
3. Update shared/docs/MASTER_TASK_LIST.md checkbox statuses
...
1. Copy relevant tasks from `shared/docs/MASTER_TASK_LIST.md` into a new sprint block in `shared/docs/SPRINT_TRACKER.md`
