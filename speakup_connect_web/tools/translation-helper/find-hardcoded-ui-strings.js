/**
 * Exhaustive inventory of likely user-facing hardcoded UI strings in speakup_connect_app/lib/.
 * Run: node speakup_connect_web/tools/translation-helper/find-hardcoded-ui-strings.js
 *      node speakup_connect_web/tools/translation-helper/find-hardcoded-ui-strings.js --json
 *      node speakup_connect_web/tools/translation-helper/find-hardcoded-ui-strings.js --check   (exit 1 if any remain)
 *
...
const LIB_DIR = path.join(REPO_ROOT, 'speakup_connect_app', 'lib');
...
function main() {
  ...
  if (asJson) {
    ...
    console.log(`Scanned ${files.length} Dart files under speakup_connect_app/lib/features, speakup_connect_app/lib/shared/widgets, form_validators.`);
