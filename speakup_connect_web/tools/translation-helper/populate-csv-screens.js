 ...
 * Docs: shared/docs/INTERNATIONALIZATION.md §11 — Populate screen column for reviewer CSV
 */
const fs = require('fs');
...
function main() {
  const csvFile =
    process.argv[2] ||
    path.join(__dirname, '../../../speakup_connect_app/lib/l10n/ceb_translations.csv');
