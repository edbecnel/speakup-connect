 ...
 *
 * Requirements:
 *   npm install firebase-admin   (run once in the project root or scripts/)
 *
 * Authentication:
 ...
 *     2. Generate a new private key → save as scripts/service-account.json
 *     3. set GOOGLE_APPLICATION_CREDENTIALS=scripts\service-account.json
 *     4. node scripts/seed_categories.js
 */
